...
$(function(){
    ...
    $("#title").formValidator({onshow:"请输入标题",onfocus:"标题长度应该为2-50个字符"}).inputValidator({min:2,max:50,onerror:"标题长度应该为2-50个字符"});
...
<div class="nav10"></div>
<form name="myform" id="myform" action="<?=base_url();?>index.php/scase/edit" method="post" enctype="multipart/form-data" />
<div class="pad-10">
<div class="col-tab">
