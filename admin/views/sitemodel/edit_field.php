...
<div class="cate_top">
     <a href="<?=base_url();?>index.php/sitemodel/add_field/<?=$data['res']['modelid']?>" class="on"><em>添加字段</em></a>
       <span>|</span><a href="<?=base_url();?>index.php/sitemodel/field_list/<?=$data['res']['modelid']?>" class="on"><em>管理模型字段</em></a>
  </div>
