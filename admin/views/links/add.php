...
<div class="nav10"></div>
<form name="myform" id="myform" action="<?=base_url();?>index.php/links/add" method="post" enctype="multipart/form-data" />
<div class="pad-10">
<div class="col-tab">
...
<table width="100%" class="table_form ">
	...
	<tr>
        <th>链接URL：</th>
        <td><input type="text" name="info[url]" id="url" class="input-text" size="40" value="http://"></td>
      </tr>
