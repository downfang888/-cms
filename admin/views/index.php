...
<div id="top_data">
    <div id="logo">
       <a href="javascript:;"><h2>网站后台管理系统(CICMS)</h2></a>
     
    </div>
    <div class="top-text">
   <a href="<?=base_url();?>index.php/my_cache/chearall">清除缓存</a> |
        | <a href="<?=base_url().'../'?>" target="_blank">网站主页</a>
...
<script type="text/javascript">
   ...
   '40':{Text:'其他模块管理',Parent:'1'},
	  ...
	  '44':{Text:'搜索词管理',Parent:'40',url:'<?=base_url();?>index.php/search/'},
   '50': {Text:'系统'},
