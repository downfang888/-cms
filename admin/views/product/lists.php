...
<?php if(!empty($data['list'])){ foreach ($data['list'] as $v){?>
    <tr>
		...
		<td>
		<a href="<?=base_url().'../product/show/'.$v['id'].'.html'?>" target="_blank"><?=$v['title']?></a>
 ...
 <?php }}else{?>
	...
	<?php } ?> 
     ...
     <div class="btn">
    	<input type="button" class="button" value="排序" onclick="myform.action='<?=base_url();?>index.php/product/order';myform.submit();"/>
