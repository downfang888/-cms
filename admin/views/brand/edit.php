...
<div class="nav10"></div>
<form name="myform" id="myform" action="<?=base_url();?>index.php/brand/edit" method="post" enctype="multipart/form-data" />
<div class="pad-10">
<div class="col-tab">
...
<?php foreach ($data['list'] as $v){
	  ...
	  <tr>
    	...
    	<tr>
        <th>品牌描述：</th>
        <td><textarea name="info[content]" id="des" style="width:70%;height:46px;"><?=$data['res']['content']?></textarea>
        </td>
      </tr>
      <tr>
        <th>审核通过：</th>
