...
class Brand extends MY_Controller {
   ...
   public function __construct(){
		parent::__construct();
		$this->m=$this->load->model("Brandm");//加载友情链接模型
		$this->load->model("Publicm");//加载公共模型
        $this->load->library("MY_page");//分页模型
		$this->m=$this->Brandm;//重命名友情链接
...
//品牌分类排序
   public  function order_list_type(){	
            $data=$this->input->post();
		    $this->m->order_list_type($data['listorder']);
