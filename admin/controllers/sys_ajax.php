...
*/
   ...
   public  function ajax_test_email(){	
	 ...
	 $this->email->from($config['smtp_user'], '测试邮件');//发件人
	 $this->email->subject('cicms 邮件测试');
	 $this->email->to($_POST['test_email']);
	 $this->email->message("恭喜您，邮箱配置正确<br>this is a test mail from cicms team");
