 ...
 *  控制器
 */
class Scase extends MY_Controller{
	public function __construct(){
		parent::__construct();
		$this->m=$this->load->model("Scasem");//加载新闻模型
		$this->m=$this->Scasem;//重命名新闻模型
	...
	public function lists(){
		...
		//配置分页
		$GLOBALS['wl_page']['scase']=isset($GLOBALS['wl_page']['scase'])?$GLOBALS['wl_page']['scase']:10;
		$page_list = config_page($count,$this->model.'/lists/'.$pagecatid,$GLOBALS['wl_page']['scase']);
