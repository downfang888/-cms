...
class News extends MY_Controller{
	public function __construct(){
		parent::__construct();
		$this->m=$this->load->model("Newsm");//加载新闻模型
		$this->m=$this->Newsm;//重命名新闻模型
	...
	public function lists(){
		...
		//配置分页
		$GLOBALS['wl_page']['news']=isset($GLOBALS['wl_page']['news'])?$GLOBALS['wl_page']['news']:10;
		$page_list = config_page($count,$this->model.'/lists/'.$pagecatid,$GLOBALS['wl_page']['news'],2,3,$npage[1]);
